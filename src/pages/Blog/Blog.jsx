...
const Blog = () => {
  ...
  return (
    <div className="mt-3 mt-md-5 pt-md-3">
      <div className="container shadow bg-body rounded border border-1 mb-3 mt-5 p-0">
        <div className="row after:col-12  m-0 ">
          ...
          >
            ...
            >
              <h3
                className="text-white fw-normal mx-5"
      ...
      <div className="container shadow bg-body rounded  border border-1 mb-3">
        <h1
          className="text-black fw-normal text-center mt-5"
          style={{ letterSpacing: "5px" }}
        >
          Spring Sale Per Category
        </h1>
        <div className="img-block d-flex justify-content-evenly align-items-center my-5 py-5 flex-wrap">
          <div
            className="col-sm-4 mt-2 col-md-2 text-center"
          ...
          <div
            className="col-sm-4 mt-2 col-md-2 mx-4 text-center"
            style={{ overflow: "hidden" }}
          >
            <img
              src={img8}
      ...
      <div className="container shadow bg-body rounded  border border-1 mb-3">
        ...
        <div className="row">
          <div
            className="col-sm-4 mt-5 position-relative p-0"
          ...
          >
            ...
            >
              <h1 className="text-center text-white fw-normal">
                The Pantsuit <br></br> Collection
              </h1>
            </div>
          </div>
          <div
      ...
      <div className="container shadow bg-body rounded border border-1 mb-3">
        ...
        <div className="row justify-content-center align-items-center my-5 py-5">
          <div className="col-12 col-md-3 mt-2 text-center position-relative">
            ...
            <h3
              className="image-overlay text-white"
              style={{
                position: "absolute",
                bottom: "10%",
                left: "50%",
      ...
      <div
        className="container shadow bg-body rounded  border border-1 mb-3 p-0 visit-container"
        style={{ height: "80vh" }}
      >
        <div
          className=""
        ...
        >
          ...
          >
            <h1
              className="text-white visit-title"
              style={{ margin: "0", fontSize: "65px", letterSpacing: "5px" }}
            >
              Visit Our<br></br>Physical Stores
            </h1>
            <button className="btn btn-lg btn-primary px-5 mt-5 visit-button">
              Visit
            </button>
          </div>
        </div>
        ...
        >
          ...
          >
            <h1
              ...
              style={{ margin: "0", letterSpacing: "5px" }}
            >
              Need Anything?
            </h1>
            <div className="mt-5 pt-5 ">
              <hr
                className="hr text-white mt-5 pt-5"
                style={{
                  position: "absolute",
                  borderColor: "white",
                  width: "100%",
              ...
              />
              <div
                className="d-flex gap-1 pt-3 mt-5 info-div text-center"
              ...
              <hr
                className="hr text-white mt-1 pt-1"
                style={{
                  position: "absolute",
                  borderColor: "white",
                  width: "100%",
              ...
              />
              <div
                className="d-flex gap-1 pt-3 info-div text-center"
                style={{ color: "white", margin: "0" }}
              >
