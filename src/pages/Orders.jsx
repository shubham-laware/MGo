...
const OrdersPage = () => {
  return (
    <div className="border ">
      ...
      {/* <section
        className="h-100 gradient-custom  container  d-flex gap-5 "
        style={{ backgroundColor: "" }}
      >
        <div className=" py-5 h-100 d-flex ">
          <div className="d-flex  gap-5   align-items-center flex-wrap   ">
            <div className="col-lg-8 col-xl-12">
              <div className="card  " style={{ borderRadius: "10px" }}>
                <div className="card-header px-4 py-5 col d-flex flex-column gap-2 ">
                ...
                <div className="mt-3 px-4">
                    <div className="mobile-menu-logo">
                      <div className="mobile-search " style={{padding:0}} >
                        <form className="input-group">
                          <input
                            type="search"
                            className="form-control search-box-m"
                            style={{
                    ...
                    <div className="card-body">
                      <div className="row">
                        <div className="col-md-2">
                          <img src={Imgs} className="img-fluid" alt="Phone" />
                        </div>
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-10">
                          ...
                          <div className="d-flex justify-content-between">
                            ...
                            <p className="text-muted mb-0">
                              <span className="fw-bold me-4">GST 18%</span> 150
                              RS
                            </p>
                          </div>
        ...
        <div className=" col-3  my-md-5  pt-md-5 " style={{ height: "350px" }}>
              <div
                className=" h-100  border rounded my-md-5"
      ...
      <div className=" d-flex  flex-wrap justify-content-center  ">
        ...
        <div className="  col-12 col-md-3  px-2 px-md-5 " >
          ...
          >
            <AdsCarousel productImages={productImages}/>
          </div>
        </div>
        </div>
      </div>
