   ...
   <div className="container">
    ...
    <div className="sidenav-header">
      ...
      <a className="navbar-brand m-0" href="https://demos.creative-tim.com/soft-ui-dashboard/pages/dashboard.html" target="_blank">
        ...
        <span className="ms-1 font-weight-bold">Minitgo <sup>Client</sup></span>
      </a>
    </  div>
      ...
      <ul className="navbar-nav">
        <li className="nav-item">
          <a className="nav-link  active" href="../pages/dashboard.html">
            <div className="   icon-shape icon-lg fa-lg   shadow border-radius-md bg-secondary text-center me-2 d-flex align-items-center justify-content-center">
        ...
        <li className="nav-item">
          <a className="nav-link  " href="../pages/tables.html">
            <div className="  icon-shape icon-lg fa-lg shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
